...
class Node{
	...
	Node next;  // It contains address / link of the next node
...
class LinkedList{
	...
	Node head;  // It contains the head/ top node of the LinkedList
...
/*
		...
		*/
		...
		System.out.println("Is the Linked List empty?  " + theLinkedList.isEmpty());
...
//		theLinkedList.prepend(0, "O");
		...
		theLinkedList.append(2, "B");
		theLinkedList.prepend(3, "C");
		theLinkedList.append(4, "D");
